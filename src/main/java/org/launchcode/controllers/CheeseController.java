...
public class CheeseController {
    ...
    public String displayEditCheeseForm(Model model, @PathVariable int cheeseId) {
        ...
        model.addAttribute("title", "Edit - " + editedCheese.getName());
        model.addAttribute("categories",categoryDao.findAll());
    ...
    public String processEditCheeseForm(Model model, @ModelAttribute @Valid Cheese cheese, @RequestParam int categoryId, @PathVariable int cheeseId, Errors errors) {
